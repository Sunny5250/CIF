...
**This is the official implementation of the paper "Commonality in Few: Few-Shot Multimodal Anomaly Detection via Hypergraph-Enhanced Memory"**
...
Download pre-trained models [DINO](https://dl.fbaipublicfiles.com/dino/dino_deitsmall8_pretrain/dino_deitsmall8_pretrain.pth) and [Point-MAE](https://drive.google.com/file/d/1-wlRIz0GM8o6BuPTJz4kTt6c_z1Gh6LX/view?usp=sharing), then put them in `checkpoints` folder.
